...
question("What do you think `x[is.na(x)]` will give you?",
         ...
         answer("A vector of `TRUE`s and `FALSE`s", message = "Remember that using logical results within square brackets identifies the actual elements in a vector (or data frame, or matrix, but that's another story), not the logical result of the statement within the brackets."),
