...
question("What is the most frequent count?",
         ...
         incorrect = "Actually, no. Look for the highest bar and then look for the number on the x axis that more or less corresponds with it.",
         random_answer_order = TRUE,
         allow_retry = TRUE
)
```
...
```{r t, echo=FALSE}
question("What do you think the graphical parameters `lty` and `lwd` control, respectively?",
