...
Let's keep using the data set we used in [the ANOVA lesson](http://www.a-mess.org/sb-one-way-anova/). We'll recreate our ANOVA fit, then run the Tukey-Kramer test to see which pairs differ from each other.
