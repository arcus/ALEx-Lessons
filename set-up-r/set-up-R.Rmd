...
This tutorial will help you set up your computer to use R. It will teach you how to:

* Install R on your computer
* Install the RStudio IDE (code editor)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/ufzQxIqNuwM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

```{r how-to-clear-the-console, echo=FALSE}
question("How do you clear the console in RStudio?",
         answer("`ctrl-l`", correct = TRUE),
         answer("`ctrl-n`"),
         answer("`cmnd-l`"),
         answer("`clear_console()`"),
         random_answer_order = TRUE,
         allow_retry = TRUE,
         correct = "You are amazing!",
         incorrect = "No. Maybe you need to watch the video (or watch it again)."
)
```
