...
However it's important to note that R provides a common API (a common set of commands) for interacting with files, that way syour code will work across different kinds of computers.
