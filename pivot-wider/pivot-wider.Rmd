...
Many tools used to analyze these data need it in a form in which each station is a column. The basic `pivot_wider` syntax is this:
...
[Hadley Wickham, et al.](https://tidyr.tidyverse.org/articles/pivot.html) for even more examples of pivoting, including how to use `pivot_wider` to do aggregation. 
