...
Well, `git rebase` does the same thing, but it takes all your changes from one branch and puts them _after_ the other branch. Use `git rebase` when you don't particularly care _when_ you made changes: you just want all the changes in one place so you can move forward.
