...
```{r one-box, include = TRUE, echo = FALSE}
fname <- paste("https://storage.googleapis.com/public-braunsb-media/Arcus-Education-Assets/Lessons/images/AirCln1.png")
...
```{r two-box, include = TRUE, echo = FALSE}
fname <- paste("https://storage.googleapis.com/public-braunsb-media/Arcus-Education-Assets/a-MESS%20Lessons/images/2%20boxes.png")
knitr::include_graphics(fname)
```
...
```{r two-plot-4-box, include = TRUE, echo = FALSE, fig.width = 2}
fname <- paste("https://storage.googleapis.com/public-braunsb-media/Arcus-Education-Assets/a-MESS%20Lessons/images/2%20plots%204%20boxes.png")
knitr::include_graphics(fname, dpi = NULL)
