...
**Another Hint**: If you see a red ex next to your code, DO NOT RUN IT or this tutorial might freeze or crash. If it does freeze or crash, simply reload it. Your prior work will have been saved (except for the bit that didn't work).

## Introduction to `ggplot2`

In lessons, we gave you an overview of the three plotting systems in R. In this lesson, we'll focus on the third and newest plotting system in R, `ggplot2`.  As we did with the other two systems, we'll focus on creating graphics on the screen device rather than another graphics device.
