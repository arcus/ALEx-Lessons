...
Now you know the basics of pivot wider, [see the article by Hadley Wickham et al.](https://tidyr.tidyverse.org/articles/pivot.html) for even more examples of pivoting, including how to use `pivot_wider` to do aggregation. 