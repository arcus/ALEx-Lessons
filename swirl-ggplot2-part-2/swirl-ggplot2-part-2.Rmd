...
x <- rnorm(100, -2.75, 2.75)
y <- rnorm(100, -2.75, 2.75)
testdat <- cbind(x, y)
...
question("Why are some aesthetics not passed to the `aes` function but others are?",
...
You could have done these labels with separate calls to labs but we thought you'd be sick of this by now. Anyway, congrats! You've concluded part 2 of ggplot2. We hope you got enough mileage out of the lesson. If you like ggplot2 you can do some extras with the extra lesson.
