...
Now let's explore ways to query the data but limit the number of rows returned to just one row per subject. We'll go into detail about each of the strategies 
