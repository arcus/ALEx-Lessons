...
Since we're goig to be measuring distances between dates rather than using them as factors, we need to make sure they are in `date` format. Make sure they are, using the syntax `date_var <- as.Date(date_var)`. (Substitute the actual variable names for `date_var`.)
