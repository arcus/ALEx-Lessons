...
Let's do it. Use what you know about R to change the class of `date` in the two data sets from a factor to a date class object. If you need to review how to do this, check out the [swirl lesson about dates in R](../swirl-dates-and-times/).
