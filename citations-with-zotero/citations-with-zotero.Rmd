...
__Zotero__ is a free and open source alternative which can be installed without administrator privilages.

### __Why Do I Need a Reference Manager?__

__Zotero__ offers a number of advantages:
 
1. Zotero acts as a convient way to store and organize PDFs of your papers
2. Zotero makes it easy to automatically cite papers in a manuscript in Microsoft Word or Open Office using the appropriate format for you selected journal
...
question("Which of the following is NOT a potential benefit of Zotero discussed above?",
         answer("Zotero is free to downlaod and use."),
         ...
         answer("You are entiled to real-time technical support.", correct = TRUE),
...
2. The browser plugin, `Zotero connect`, used to easily import new papers

Install the main reference manager program by visiting [the download page](https://www.zotero.org/download/).

On that same page, you will likely find a link to __Zotero Connect__ that matches your browser. 
...
Once __Zotero__ is installed, you can also install __Zotero Connect__. 
...
Now that __Zotero__ has been installed, your orginization may have a common library of publications to get get you started. 
...
Once the importation process is compelete, you will see the papers in your Zotero library.
...
__Note that the style can be changed at any time using the same proceedure.__
...
A search box will appear where you can begin searching for the papper you wish to cite. You can search for and metadata element including author, title, journal, and year. 
