...
Daniel Smilkov and Shan Carter continued many people’s previous work (most notably Andrej Karpathy’s convnet.js demo and Chris Olah’s articles about neural networks) to create an online playground where you can learn about neural nets. 
...
Many thanks to Daniel Smilkov, Shan Carter, Andrej Karpathy, Chris Olah, D. Sculley, Fernanda Viégas, Martin Wattenberg for their amazing work and for choosing an [Apache license](https://github.com/tensorflow/playground/blob/master/LICENSE) that lets us all freely make use of said contributions.
