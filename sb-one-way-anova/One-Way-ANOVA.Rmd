...
Many people choose to show their data as boxplots because boxplots are usuall cleaner visualizations. However, the density plot provides good information about our data:
...
there are a groups, there are $\displaystyle \frac{a^2 -a}$(a2–a)/2 possible pairwise comparisons, a number that quickly
