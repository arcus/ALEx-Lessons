...
You can use the boolean operators (e.g. >, <, >=, <=, !=, %in%) to create the logical tests. If you are not familiar with how to use conditional logic, download and run the [Logic](../swirl-logic/) lesson for some practice. It's based on the `swirl` lesson of the same name. 
