...
question("When I see a Python statement that uses a single equals sign, like `dog_age = dog_age + 1`,  I expect the program to... ",
         ...
         answer("... evaluate both sides simultaneously"),
...
`int` or **Integer** refers to a whole number. This type of of value cannot accept a decimial place. Do you think an integer can accept a negative sign?
