...
question("R is great because it...",
         ...
         answer("Has more standardized methods about how to do things Python's wild wild west nature", correct = TRUE),
...
1. Both languages support literate statistical programming.    
...
question("What's can you do with a REPL?",
