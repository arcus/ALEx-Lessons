...
OTHER TIP: If you have a red "x" next to your code and you submit it anyway, the lesson might freeze. If that happens to you, use your browser to reload it and try again. 
...
question("Which of the following commands do you think would give us the second element of `vect`?",
         ...
         answer("vect[“2”]",
                message = "If you look very closely, you will see that the quotation marks are curled. R does not recognize curly quotes as quotation marks. You end up with curly quotation marks sometimes when you copy things from Word."),
         answer("vect[“bar”]", 
                message = "If you look very closely, you will see that the quotation marks are curled. R does not recognize curly quotes as quotation marks. You end up with curly quotation marks sometimes when you copy things from Word."),
         random_answer_order = TRUE,
         allow_retry = TRUE
