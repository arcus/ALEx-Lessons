...
The following code checks to see if you have the required packages and, if you don't, installs them to your R environment. You can copy and paste this code into your local copy of RStudio. 

```{r packages, exercise=FALSE, eval = FALSE}
library(rankFD)
library(FSA)
library(dplyr)
library(DescTools)
...
```{r mutatedata, exercise = TRUE, exercise.lines = 5}
