...
To make sure we all get the same random variables, let's first set the seed, or the starting point for the randomization, to 10 using the command `set.seed(10)`. 
...
Next, let’s create a vector containing 1000 `NA`s with `z <- rep(NA, 1000)`. Please set the seed first to 8.
