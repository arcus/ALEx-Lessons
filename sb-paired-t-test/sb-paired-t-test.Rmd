...
For a thorough treatment of the background for _t_ tests generally, see our lessons [One-Sample _t_ Test]("http://a-mess.org/sb-one-sample-t-test/") and [Two-Sample _t_ Test]("http://a-mess.org/sb-two-sample-t-test/").
